...
function resetDraggedPieceStyles(draggedPiece: HTMLImageElement) {
    draggedPiece.classList.remove("dragged");
    draggedPiece.style.left = "";
    draggedPiece.style.top = "";
}

function drawBoardfromFEN(FEN: string, isBoardFlipped = false) {
...
async function getPromotionSelection(color: PieceColor) {
...
async function checkLegality(data: MoveData) {
